...
$email = $_POST['emailproduto'];
$telefone = $_POST['telefoneproduto'];
//$cep = $_POST['cep'];
//$anexo = $_POST['anexo'];
...
$hora_envio = date('H:i:s');
	...
	$mail->FromName = 'Interesse de produtos';                     // Nome no remetente
	...
	$mail->Subject = 'Solicitação de Contato de produtos';
	$mail->Body    = ($nome . $telefone . $email);
